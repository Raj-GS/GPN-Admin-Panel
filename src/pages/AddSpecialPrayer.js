...
export default function AddSpecialPrayer() {
...
console.log('Image URL:', templates.find(t => t.id === selectedTemplateId)?.image);
    ...
    if (response.ok) {
      alert("Special prayer added successfully");
      ...
      <Paper elevation={3} sx={{ p: 4, width: "100%", maxWidth: "900px" }}>
        ...
        >
         ...
         <FormControl fullWidth required>
                ...
                <Select label="Category" defaultValue={category} onChange={(e) => setCategory(e.target.value)}>
                  <MenuItem value="">
   ...
   <Box
        ...
        >
           ...
           <FormControl fullWidth required>
                ...
                <Select label="Category" defaultValue={prayerPlan} onChange={(e) => setPrayerPlan(e.target.value)}>
        ...
        <Box flex="1 1 48%" mt={2}>
           <FormControl fullWidth required>
                ...
                <Select label="Category" defaultValue={slotDuration} onChange={(e) => setSlotDuration(e.target.value)} >
                  <MenuItem value="">
...
{prayerFrequency=="Weekly" && (
  ...
  <Button variant="contained" onClick={handleAddScripture} sx={{ mt: 1 }}>
    + Scripture
  </Button>
</Box>
